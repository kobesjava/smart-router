...
} from './multicall-uniswap-provider'
 ...
 */
export class UniswapMulticall3Provider extends IMulticallProvider<UniswapMulticallConfig> {
  ...
  >(
    ...
    const { blockNumber, returnData: aggregateResults } =
      await this.multicallContract.callStatic.blockAndAggregate(calls, {
